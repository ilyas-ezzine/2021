<div>
    <div class="card">
       ...
       <div class="card-header">
        ...
        <div class="card-body">
            <a type="button" class="btn btn-primary"  href="{{route('admin.facturasgastos.create')}}">Añadir Factura</a>
        </div>
        @if ($facturas->count())
        ...
        <table class='table table-striped'>
            ...
            <tbody>
                ...
                <td width='10px'><a href="{{route('admin.facturasgastos.edit', $factura)}} " button type="button" class="btn btn-warning">Editar</a></td>
