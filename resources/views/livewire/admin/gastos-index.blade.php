<div>
    <div class="card">
       ...
       <div class="card-header">
        ...
        <div class="card-body">
            <button class="btn btn-success" ><a href="{{route('admin.otrosgastos.create')}}">Añadir otrosgasto</a></button>
        </div>
        ...
        <table class='table table-striped'>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$otrosgasto->Concepto}}</td>
                    
                
                    <td><a href="">{{$otrosgasto->Ruta}}</a></td>
                    
                <td width='10px'><a href="{{route('admin.otrosgastos.edit', $otrosgasto)}} " button type="button" class="btn btn-warning">Editar</a></td>
